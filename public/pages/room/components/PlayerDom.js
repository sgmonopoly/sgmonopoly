export default class PlayerDom {
    constructor({id, name = 'anonymous', color='#6ecfff', img = 'http://img.25pp.com/uploadfile/app/icon/20161025/1477405420543256.jpg', heroCount = 0, troops = 0, money = 0, citiesCount = 0}){
        this.id = id
        this.name = name
        this.color = color
        this.img = img

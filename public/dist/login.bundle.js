...
/***/ function(module, exports, __webpack_require__) {
	...
	function onInputFocus() {
	    (0, _jquery2.default)('.background-container').addClass('background-focus');
	    (0, _jquery2.default)('.input-container').addClass('input-container-focus');
	}
	
	function onInputBlur() {
	    (0, _jquery2.default)('.background-container').removeClass('background-focus');
	    (0, _jquery2.default)('.input-container').removeClass('input-container-focus');
	}
	
	function clearForm() {
	    (0, _jquery2.default)('#err-content').html('');
	    (0, _jquery2.default)('.form-value').removeClass('err-box');
	}
	
	function setErrorInfo(msg, domId) {
	    (0, _jquery2.default)('#' + domId).addClass('err-box');
	    (0, _jquery2.default)('#err-content').html(msg);
	}
	...
	function login() {
	    ...
	    if (isValid(name)) {
	        (0, _user.userLogin)(name).then(function () {
	            console.log('success!');
	            (0, _router.open)(_pages.pages.rooms);
	        }).catch(function (err) {
	            console.log(err);
	        });
	    }
	...
	function initPage() {
	    ...
	    (0, _jquery2.default)('.input-container').mouseenter(function () {
	        onInputFocus();
	    });
	
	    (0, _jquery2.default)('.input-container').mouseleave(function () {
	        onInputBlur();
	    });
...
/***/ function(module, exports, __webpack_require__) {
	...
	function userLogin() {
	    ...
	    var avatar = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
	
	    return _axios2.default.post('/user/login', {
	        nickname: nickname,
	        avatar: avatar
	    });
	}
...
/***/ function(module, exports) {
	...
	function _addParams() {
	    ...
	    return keys.reduce(function (url, key, index) {
	        if (index === 0) {
